...
print(f"[DEBUG] DATA_DIR env: {os.getenv('DATA_DIR')}")
print(f"[DEBUG] DB_PATH: {DB_PATH}")
print(f"[DEBUG] DB_PATH absolute: {os.path.abspath(DB_PATH)}")
print(f"[DEBUG] DB file exists before connect: {os.path.exists(DB_PATH)}")
try:
    print(f"[DEBUG] DATA_DIR contents: {os.listdir(DATA_DIR)}")
except Exception as e:
    print(f"[DEBUG] DATA_DIR listdir error: {e}")
